        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-5 flex gap-3">
              <a href="https://wa.me/91XXXXXXXXXX" className="w-9 h-9 rounded-full bg-green-500 hover:bg-green-400 flex items-center justify-center transition-colors" aria-label="WhatsApp">
              ...
              <a href="tel:+91XXXXXXXXXX" className="w-9 h-9 rounded-full bg-aqua-600 hover:bg-aqua-500 flex items-center justify-center transition-colors" aria-label="Call">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-aqua-300">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/91XXXXXXXXXX" className="hover:text-white transition-colors">WhatsApp Order</a>
              </li>
            </ul>
          </div>
        </div>
