    ...
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                ...
                <a href="tel:+91XXXXXXXXXX" className="border-2 border-white/60 text-white hover:bg-white/10 font-semibold px-8 py-4 rounded-full transition-all text-center backdrop-blur-sm">
                  📞 Call to Order
                </a>
              </div>
      ...
      <section className="py-16 water-bg">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/91XXXXXXXXXX?text=Hi%20KD%20Aqua!%20I%20want%20to%20order." target="_blank" rel="noopener noreferrer"
